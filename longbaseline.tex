...
In the antineutrino mode, the fraction of neutrino interactions is relatively large. For instance, in the case of T2K, roughly 30\% of the interactions at SK in antineutrino mode are given by neutrinos. This is due to the the fact that more $\pi^+$ than $\pi^-$ are produced in proton-carbon interactions and that \nu cross-section are larger than \nub cross-sections. 
